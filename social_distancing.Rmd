...
```{r}
social_distancing_11_15 <- read_csv("data/social_distancing_11-15.csv", skip = 2,
                              col_type = cols(Location = col_character(),
                                              `Status of Reopening` = col_character(),
                                              `Stay at Home Order` = col_character(),
                                              `Mandatory Quarantine for Travelers` = col_character(),
...
saveRDS(social_distancing_11_15, file = "socialdistancing_11_15.RDS")

social_distancing_11_15 <- read_rds("socialdistancing_11_15.RDS")
```
