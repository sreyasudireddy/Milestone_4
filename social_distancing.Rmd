...
plot_usmap(data = map_restaurant, values = "restaurant_limits") +
  ...
  scale_fill_manual(name = "Policy", labels = c("No Data", "New Service Limits", "Reopened to Dine-in Service", "Reopened to Dine-in Service with Capacity Limits"), values = c("#98E2C6", "#BFEDEF", "#BBC6CE", "#C4B7CB")) +
